...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_two_different_places_created_at(self):
        plc1 = Place()
        sleep(0.05)
        plc2 = Place()
        self.assertLess(plc1.created_at, plc2.created_at)

    def test_two_different_places_updated_at(self):
        plc1 = Place()
        sleep(0.05)
        plc2 = Place()
...
class TestPlace_save(unittest.TestCase):
    """Testing save method of the class, Place"""
...
class TestPlace_to_dict(unittest.TestCase):
    """Testing to_dict method of the class, Place."""
